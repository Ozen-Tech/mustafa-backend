...
# Cloudinary service removido - usando apenas URLs do Twilio
...
def delete_foto(db: Session, foto: models.FotoPromotor) -> None:
    ...
    Nota: As fotos ficam armazenadas no Twilio, então apenas removemos
    o registro do banco de dados. As URLs do Twilio continuam válidas.
    """
